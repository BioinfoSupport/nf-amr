...
```{r}
assemblies |>
	select(assembly_id,num_contig,assembly_length,species_name,mlst_type,orgfinder.species_name,orgfinder.ani) |>
	...
	gt::fmt_number(c(orgfinder.ani),decimals = 1,pattern="{x}%") |>
